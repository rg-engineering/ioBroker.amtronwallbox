...
class amtron_MHCP extends base_1.default {
    constructor(adapter, id, config, readInterval, timezone) {
    ...
    */
    ...
    async checkVariables_MHCP_Statistic(period) {
        let key;
        let obj;
        //statistic data
        const SystemName = this.Name.replace(this.GetForbiddenChars(), "_");
...
exports.default = amtron_MHCP;
//# sourceMappingURL=amtron_MHCP.js.map